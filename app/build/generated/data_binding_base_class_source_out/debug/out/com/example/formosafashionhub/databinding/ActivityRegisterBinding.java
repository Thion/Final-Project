...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView2,
      @NonNull Button mBtnRegister, @NonNull EditText mEdtEmailRegister,
      @NonNull EditText mEdtPasswordRegister, @NonNull EditText mEdtUsernameRegister,
      @NonNull TextView mTvRegister, @NonNull TextView textViewSignup) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ConstraintLayout) rootView, cardView2, mBtnRegister,
          mEdtEmailRegister, mEdtPasswordRegister, mEdtUsernameRegister, mTvRegister,
          textViewSignup);
    }
